...
class TavilySearch(SearchEngine):
    ...
    Best for: AI-optimized web search, general web queries,
    news, and real-time information with relevance scoring.
    """
    ...
    def get_tool_definition(cls, server_name: str = 'web_search') -> 'Tool':
        ...
        return Tool(
            ...
            description=(
                ...
                'Best for: AI-optimized web search, general queries, '
