...
class TavilySearch(SearchEngine):
    ...
    Best for: LLM-optimized web search, real-time information retrieval,
    general/news/finance topic search with relevance scoring.
    """
    ...
    def get_tool_definition(cls, server_name: str = 'web_search') -> 'Tool':
        ...
        return Tool(
            ...
            description=(
                ...
                'Best for: LLM-optimized web search, real-time information, '
                'general/news/finance topics with relevance scoring. '
            ...
            parameters={
                ...
                'properties': {
                    'query': {
                        ...
                        'string',
                        'description':
                        'The search query. Keep under 400 characters.',
                    },
                    'num_results': {
                        'type':
                        'integer',
                    ...
                    'search_depth': {
                        ...
                        ('Search depth. "basic" for fast results, '
                         '"advanced" for highest relevance. '
                         'Default is "advanced".'),
                    },
                    'topic': {
                        'type':
